...
public class OnSuccessAndFaultSub extends DisposableObserver<WeatherBean>
     ...
     */
    @Override
    public void onNext(WeatherBean body) {
        try {
...
//            }
            ...
            e.printStackTrace();
            mOnSuccessAndFaultListener.onFault("请求异常");
            dispose();//请求完毕直接取消订阅
            Log.e("OnSuccessAndFaultSub", "errorMsg: " + "请求异常");
        }
    }
